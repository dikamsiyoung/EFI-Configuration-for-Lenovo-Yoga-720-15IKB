...
Clone this repository, unzip the file and copy the EFI folder of your preferred macOS version to your newly opened EFI partition. This EFI is pretty much ready to go, however a few things need to be set before you are ready for installation and after you've installed macOS.  
